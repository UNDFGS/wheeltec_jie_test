...
public:
    ...
    // ================== 🔥【2026.3.31 新增：暴露 SC 匹配距离给外部模块】起始 ==================
    // 每次 detectLoopClosureID 执行后，最近一次的 SC 最小距离会存在这里
    // 线程2 在投递 LoopCandidate 时读取此值，传递给线程3 的 Confidence Model
    double sc_last_distance_ = 0.0;
    // ================== 🔥【2026.3.31 新增：暴露 SC 匹配距离给外部模块】结束 ==================
